...
export default async function faceSwapOrderQueue() {
	// Check if the service is running
	if ((global as any).isFaceSwapRunning) {
	...
	console.log('///////////////////////////////');
	(global as any).isFaceSwapRunning = true;
	...
	const processOrders = async () => {
		try {
			...
			if (orders.length === 0) {
				...
				console.log('///////////////////////////////');
				console.log('///////////////////////////////');
				(global as any).isFaceSwapRunning = false;
				return;
			}
