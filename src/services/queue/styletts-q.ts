...
export default async function styleTTSOrderQueue() {
	// Check if the service is running
	if ((global as any).isStyleTTSRunning) {
	...
	console.log('///////////////////////////////');
	(global as any).isStyleTTSRunning = true;
	...
	const processOrders = async () => {
		try {
			...
			if (orders.length === 0) {
				...
				console.log('///////////////////////////////');
				console.log('///////////////////////////////');
				(global as any).isStyleTTSRunning = false;
				return;
			}
