...
export default async function kandinskyOrderQueue() {
	// Check if the service is running
	if ((global as any).isKandinskyRunning) {
	...
	console.log('///////////////////////////////');
	(global as any).isKandinskyRunning = true;
	...
	const processOrders = async () => {
		try {
			...
			if (orders.length === 0) {
				...
				console.log('///////////////////////////////');
				console.log('///////////////////////////////');
				(global as any).isKandinskyRunning = false;
				return;
			}
