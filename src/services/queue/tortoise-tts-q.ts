...
export default async function tortoiseTTSOrderQueue() {
	// Check if the service is running
	if ((global as any).isTortoiseTTSRunning) {
	...
	console.log('///////////////////////////////');
	(global as any).isTortoiseTTSRunning = true;
	...
	const processOrders = async () => {
		try {
			...
			if (orders.length === 0) {
				...
				console.log('///////////////////////////////');
				console.log('///////////////////////////////');
				(global as any).isTortoiseTTSRunning = false;
				return;
			}
