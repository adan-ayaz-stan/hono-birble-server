...
export default async function songStarterOrderQueue() {
	// Check if the service is running
	if ((global as any).isSongStarterRunning) {
	...
	console.log('///////////////////////////////');
	(global as any).isSongStarterRunning = true;
	...
	const processOrders = async () => {
		try {
			...
			if (orders.length === 0) {
				...
				console.log('///////////////////////////////');
				console.log('///////////////////////////////');
				(global as any).isSongStarterRunning = false;
				return;
			}
