...
export default async function photomakerOrderQueue() {
	// Check if the service is running
	if ((global as any).isPhotomakerRunning) {
	...
	console.log('///////////////////////////////');
	(global as any).isPhotomakerRunning = true;
	...
	const processOrders = async () => {
		try {
			...
			if (orders.length === 0) {
				...
				console.log('///////////////////////////////');
				console.log('///////////////////////////////');
				(global as any).isPhotomakerRunning = false;
				return;
			}
