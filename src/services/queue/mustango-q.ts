...
export default async function mustangoOrderQueue() {
	// Check if the service is running
	if ((global as any).isMustangoRunning) {
	...
	console.log('///////////////////////////////');
	(global as any).isMustangoRunning = true;
	...
	const processOrders = async () => {
		try {
			...
			if (orders.length === 0) {
				...
				console.log('///////////////////////////////');
				console.log('///////////////////////////////');
				(global as any).isMustangoRunning = false;
				return;
			}
