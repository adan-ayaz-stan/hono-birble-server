...
export default async function musicgenOrderQueue() {
	// Check if the service is running
	if ((global as any).isMusicgenRunning) {
	...
	console.log('///////////////////////////////');
	(global as any).isMusicgenRunning = true;
	...
	const processOrders = async () => {
		try {
			...
			if (orders.length === 0) {
				...
				console.log('///////////////////////////////');
				console.log('///////////////////////////////');
				(global as any).isMusicgenRunning = false;
				return;
			}
