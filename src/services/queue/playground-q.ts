...
export default async function playgroundOrderQueue() {
	// Check if the service is running
	if ((global as any).isPlaygroundRunning) {
	...
	console.log('///////////////////////////////');
	(global as any).isPlaygroundRunning = true;
	...
	const processOrders = async () => {
		try {
			...
			if (orders.length === 0) {
				...
				console.log('///////////////////////////////');
				console.log('///////////////////////////////');
				(global as any).isPlaygroundRunning = false;
				return;
			}
