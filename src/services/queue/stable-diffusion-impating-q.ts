...
export default async function SDImpantingOrderQueue() {
	// Check if the service is running
	if ((global as any).isSDImpantingRunning) {
	...
	console.log('///////////////////////////////');
	(global as any).isSDImpantingRunning = true;
	...
	const processOrders = async () => {
		try {
			...
			if (orders.length === 0) {
				...
				console.log('///////////////////////////////');
				console.log('///////////////////////////////');
				(global as any).isSDImpantingRunning = false;
				return;
			}
