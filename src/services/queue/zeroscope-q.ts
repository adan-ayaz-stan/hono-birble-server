...
export default async function zeroScopeOrderQueue() {
	// Check if the service is running
	if ((global as any).isZeroScopeRunning) {
	...
	console.log('///////////////////////////////');
	(global as any).isZeroScopeRunning = true;
	...
	const processOrders = async () => {
		try {
			...
			if (orders.length === 0) {
				...
				console.log('///////////////////////////////');
				console.log('///////////////////////////////');
				(global as any).isZeroScopeRunning = false;
				return;
			}
