...
export default async function instantIdOrderQueue() {
	// Check if the service is running
	if ((global as any).isInstantIdRunning) {
	...
	console.log('///////////////////////////////');
	(global as any).isInstantIdRunning = true;
	...
	const processOrders = async () => {
		try {
			...
			if (orders.length === 0) {
				...
				console.log('///////////////////////////////');
				console.log('///////////////////////////////');
				(global as any).isInstantIdRunning = false;
				return;
			}
