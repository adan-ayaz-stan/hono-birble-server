...
export default async function animateDiffOrderQueue() {
	// Check if the service is running
	if ((global as any).isAnimateDiffRunning) {
	...
	console.log('///////////////////////////////');
	(global as any).isAnimateDiffRunning = true;
	...
	const processOrders = async () => {
		try {
			...
			if (orders.length === 0) {
				...
				console.log('///////////////////////////////');
				console.log('///////////////////////////////');
				(global as any).isAnimateDiffRunning = false;
				return;
			}
