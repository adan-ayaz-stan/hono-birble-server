...
export default async function dreamshaperOrderQueue() {
	// Check if the service is running
	if ((global as any).isDreamshaperRunning) {
	...
	console.log('///////////////////////////////');
	(global as any).isDreamshaperRunning = true;
	...
	const processOrders = async () => {
		try {
			...
			if (orders.length === 0) {
				...
				console.log('///////////////////////////////');
				console.log('///////////////////////////////');
				(global as any).isDreamshaperRunning = false;
				return;
			}
